...
import com.tang4j.security.handler.*;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        //解决通过spring security登陆后，跳转到嵌套页面，报错
...
//        //添加JWT过滤器 除/login其它请求都需经过此过滤器
        http.addFilter(new JWTAuthenticationFilter(authenticationManager(), myUserDetailService, dataSecurityAction));
//
