 ...
 *
  ...
  function MyController($scope, $http) {
    ...
    $http.get('/auth.py').success(function(data, state, headers) {
  ...
  <pre>
    ...
    describe('MyController', function() {
       ...
       it('should send msg to server', function() {
         ...
         expect($rootScope.state).toBe('Saving...');
         $httpBackend.flush();
         expect($rootScope.state).toBe('');
       });
...
function createHttpBackendMock($rootScope, $delegate, $browser) {
   ...
   *
   *  - respond –
   *      `{function([state,] data[, headers])|function(function(method, url, data, headers)}`
   *    – The respond method takes a set of static data to be returned or a function that can return
   *    an array containing response state (number), response data (string) and response headers
   *    (Object).
   */
